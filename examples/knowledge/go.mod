...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/knowledge/document/reader/pdf v0.0.0-20250916061345-d02a50b92be7
	trpc.group/trpc-go/trpc-agent-go/knowledge/embedder/gemini v0.0.0-20250916061345-d02a50b92be7

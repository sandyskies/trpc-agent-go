...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/knowledge/document/reader/pdf v0.0.1
	trpc.group/trpc-go/trpc-agent-go/knowledge/embedder/gemini v0.0.1
	...
	trpc.group/trpc-go/trpc-agent-go/memory/redis v0.2.2
	trpc.group/trpc-go/trpc-agent-go/session/redis v0.2.2
...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/storage/elasticsearch v0.2.2 // indirect
	trpc.group/trpc-go/trpc-agent-go/storage/redis v0.2.2 // indirect
	trpc.group/trpc-go/trpc-agent-go/storage/tcvector v0.2.2-0.20250807061029-66942a6b44d9 // indirect
)
